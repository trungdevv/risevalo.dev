...
const Header = () => {
  return (
    <header className="fixed bg-[#e11d4798] left-0 right-0 top-0 z-50 ">
      <div className="container flex w-full items-center justify-between p-2 sm:p-4 ">
        <Link className="flex justify-between items-center gap-2 z-50" href="/">
          <Logo /> VIVIANWARE
        </Link>
        ...
        <Sheet>
          <SheetTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="sm:hidden hover:text-accent"
            >
